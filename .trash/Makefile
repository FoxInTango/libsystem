...
TARGET_NAME_EXT =
#    安装位置
INSTALL_PATH    = /usr/local/libsystem
...
install :
	rm -rf /usr/local/include/libsystem
	mkdir /usr/local/include/libsystem
	cp  -rf ./include/* /usr/local/include/libsystem
	cp  -rf ./lib/libsystem.so /usr/local/lib
uninstall : 
	rm -rf /usr/local/include/libsystem
	rm -rf /usr/local/lib/libsystem.so
